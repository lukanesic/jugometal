...
export const selectSubcategoryDescription = (subcategory) => {
  ...
  // Ratarstvo
    ...
    return 'Namenjene su za osnovnu i dopunsku obradu zemljišta'
  } else if (subcategory === 'plugovi') {
    return 'Bell Impex i Agro Lemind Plugovi'
  } else if (subcategory === 'pneumatske-sejalice') {
    return 'Pneumatska sejalica je namenjena za setvu kalibrisanog i nekalibrisanog semena'
